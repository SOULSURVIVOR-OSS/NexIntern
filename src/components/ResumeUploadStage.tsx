...
import { Upload, FileText, Trash2, Plus, Sparkles, ArrowRight, ArrowLeft, Users, AlertCircle } from 'lucide-react';
        ...
        {candidates.length === 0 ? (
          <div className="text-center py-12 px-6 rounded-3xl bg-white dark:bg-[#181a20] border-2 border-dashed border-slate-200 dark:border-white/[0.1] shadow-2xs">
            ...
            <p className="text-xs text-slate-500 dark:text-[#a1a1a6] max-w-md mx-auto mt-1 mb-4 leading-relaxed">
              Your candidate pool is fresh and ready. Drop your applicant resumes into the box above or paste a custom resume to start evaluation.
            </p>
