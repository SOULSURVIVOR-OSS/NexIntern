          ...
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-1.5 flex-wrap mt-0.5">
                <p
                  className="text-xs text-slate-500 dark:text-[#a1a1a6] truncate max-w-[200px] sm:max-w-[260px]"
                  title={`${c.education.degree} • ${c.education.institution}`}
                >
                  {c.education.degree} • {c.education.institution}
                </p>
                {c.education.gpa && (
                  <span className="text-[10px] font-semibold px-1.5 py-0.2 rounded bg-black/[0.04] dark:bg-white/[0.08] text-slate-700 dark:text-slate-300">
                    CGPA {c.education.gpa}
                  </span>
                )}
                {c.projects && c.projects.length > 0 && (
                  <span className="text-[10px] font-medium px-1.5 py-0.2 rounded bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900/40">
